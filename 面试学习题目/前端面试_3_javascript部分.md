...
缺点：如for in断一样，Object.keys方法也**只返回可枚举属性**
...
Person();  // Cannot read properties of undefined (reading 'a')
```
...
![setinterval-1.png](E:\pogject\学习笔记\image\js\1460000038829251)
...
- 函数防抖**关注一定时间连续触发的事件只在最后执行一次**，而函数节流**侧重于一段时间内只执行一次**。
